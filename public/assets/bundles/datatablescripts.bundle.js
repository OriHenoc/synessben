      ...
      function (b, c) {
        if (a.isArray(b))
          ...
          for (
            ...
            j ||
              ((j = { name: f, val: {}, methodExt: [], propExt: [] }),
              i.push(j)),
  ...
  Sa("columns()", function (b, c) {
    ...
    (Ua.defaults = {
      ...
      oLanguage: {
        ...
        sInfo: "Affichage de _START_ sur _END_ (total : _TOTAL_)",
        sInfoEmpty: "Affichage de 0 sur 0 pour 0 données",
        sInfoFiltered: "(filtré à partir de _MAX_ total de données)",
        sInfoPostFix: "",
        sDecimal: "",
        sThousands: ",",
        sLengthMenu: "Affichage de _MENU_ données",
        sLoadingRecords: "Chargement...",
        sProcessing: "Traitement en cours...",
        sSearch: "Rechercher :",
        sSearchPlaceholder: "",
        sUrl: "",
        sZeroRecords: "Aucun enregistrement n'a été trouvé",
      },
